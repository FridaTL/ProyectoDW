        ...
        <button class="w3-button w3-black w3-xlarge" onclick="w3_open()">&#9776;</button>
          ...
          <div class="navegacion">
            <ul class="links">
              ...
              <li class="link"><a href="salidaB.php" style="color: darkgray;">Biografias</a></li>
            </ul>
          </div>
      </header>
    </div>
...
include "connection.php";
 ...
 $sql = "SELECT nombre,datos,id_arqui,ubi,contextoH,descr,trans,foto1,foto2,foto3,principios,importancia FROM urbanismo";
...
if (mysqli_num_rows($result) > 0) {
    ...
    while($row = mysqli_fetch_assoc($result)) {
        ...
        echo $row["foto2"]. "<br>";
        echo $row["foto3"]. "<br>";
        echo $row["principios"]. "<br>";
        echo $row["importancia"]. "<br>";
